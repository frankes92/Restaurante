...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <cac:TaxTotal>
      ...
      <cac:TaxSubtotal>
         <cbc:TaxableAmount currencyID="'.$comprobante['moneda'].'">'.$comprobante['op_gravadas'].'</cbc:TaxableAmount>
         <cbc:TaxAmount currencyID="'.$comprobante['moneda'].'">'.$comprobante['igv'].'</cbc:TaxAmount>
         <cac:TaxCategory>
            <cac:TaxScheme>
               <cbc:ID>1000</cbc:ID>
      ...
      if($comprobante['op_inafectas']>0){
         $xml.='<cac:TaxSubtotal>
            <cbc:TaxableAmount currencyID="'.$comprobante['moneda'].'">'.$comprobante['op_inafectas'].'</cbc:TaxableAmount>
            <cbc:TaxAmount currencyID="'.$comprobante['moneda'].'">0.00</cbc:TaxAmount>
            <cac:TaxCategory>
               <cbc:ID schemeID="UN/ECE 5305" schemeName="Tax Category Identifier" schemeAgencyName="United Nations Economic Commission for Europe">E</cbc:ID>
               <cac:TaxScheme>
   ...
   $subtotal = $comprobante['op_gravadas'] + $comprobante['op_exoneradas'] + $comprobante['op_inafectas'];
   $xml.='</cac:TaxTotal>
...
function CrearXMLNotaCredito($nombrexml, $emisor, $cliente, $cabecera, $detalle){
...
<CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <cbc:Note languageLocaleID="1000"><![CDATA['.$cabecera['total_texto'].']]></cbc:Note>
   <cbc:DocumentCurrencyCode>'.$cabecera['moneda'].'</cbc:DocumentCurrencyCode>
   <cac:DiscrepancyResponse>
      <cbc:ReferenceID>'.$cabecera['serie_comp_ref'].'-'.$cabecera['corr_comp_ref'].'</cbc:ReferenceID>
      <cbc:ResponseCode>'.$cabecera['cod_motivo'].'</cbc:ResponseCode>
      <cbc:Description>'.$cabecera['desc_motivo'].'</cbc:Description>
   </cac:DiscrepancyResponse>
   <cac:BillingReference>
      <cac:InvoiceDocumentReference>
         <cbc:ID>'.$cabecera['serie_comp_ref'].'-'.$cabecera['corr_comp_ref'].'</cbc:ID>
   ...
   <cac:TaxTotal>
      ...
      <cac:TaxSubtotal>
         <cbc:TaxableAmount currencyID="'.$cabecera['moneda'].'">'.$cabecera['subtotal'].'</cbc:TaxableAmount>
         <cbc:TaxAmount currencyID="'.$cabecera['moneda'].'">'.$cabecera['igv'].'</cbc:TaxAmount>
         <cac:TaxCategory>
            <cac:TaxScheme>
               <cbc:ID>1000</cbc:ID>
   ...
   <cac:LegalMonetaryTotal>
      <cbc:PayableAmount currencyID="'.$cabecera['moneda'].'">'.$cabecera['total'].'</cbc:PayableAmount>
   </cac:LegalMonetaryTotal>';
   ...
   foreach($detalle as $k=>$v){
      ...
      $xml.='<cac:CreditNoteLine>
         ...
         <cbc:LineExtensionAmount currencyID="'.$cabecera['moneda'].'">'.$v['valor_total'].'</cbc:LineExtensionAmount>
         <cac:PricingReference>
            <cac:AlternativeConditionPrice>
               <cbc:PriceAmount currencyID="'.$cabecera['moneda'].'">'.$v['precio_unitario'].'</cbc:PriceAmount>
               <cbc:PriceTypeCode>'.$v['tipo_precio'].'</cbc:PriceTypeCode>
            </cac:AlternativeConditionPrice>
         </cac:PricingReference>
         <cac:TaxTotal>
...
function CrearXMLNotaDebito($nombrexml, $emisor, $cliente, $cabecera, $detalle){
...
<DebitNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <cac:DiscrepancyResponse>
      <cbc:ReferenceID>'.$cabecera['serie_comp_ref'].'-'.$cabecera['corr_comp_ref'].'</cbc:ReferenceID>
      <cbc:ResponseCode>'.$cabecera['cod_motivo_nd'].'</cbc:ResponseCode>
      <cbc:Description>'.$cabecera['desc_motivo'].'</cbc:Description>
   </cac:DiscrepancyResponse>
   <cac:BillingReference>
      <cac:InvoiceDocumentReference>
...
function generar_xml_resumen_boletas($emisor, $cabecera, $detalle, $nombrexml){
...
function generar_xml_resumen_anulaciones($emisor, $cabecera, $detalle, $nombrexml){
